...
const MForm = ({ onFormSubmit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const formData = {
      ...
      maintenanceTime: maintenanceTimeRef.current.getValue(),
      details: detailsRef.current.getValue(),
    ...
    maintenanceTimeRef.current.clear();
  ...
  return (
    <div className="w-3/5 mx-auto py-10 px-5">
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-5">
        ...
        />
        <InputField
          ref={maintenanceTimeRef}
          label="Maintenance Time:"
          type="time"
          name="maintenanceTime"
        />
        <InputField ref={detailsRef} label="Details:" name="details" />
        <InputField
          ref={inChargeNameRef}
